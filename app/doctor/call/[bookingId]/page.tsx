  ...
  return (
    <div style={{ position: 'fixed', inset: 0, background: '#0f172a', display: 'flex', flexDirection: 'column', zIndex: 1000 }}>
      ...
      <div style={{ flex: 1, display: 'flex', overflow: 'hidden' }}>
        <div style={{ flex: 1, position: 'relative', overflow: 'hidden', background: '#1e293b' }}>
          ...
          <video
            ...
            style={{
              ...
              width: 160, height: 112, borderRadius: 12, objectFit: 'cover',
          ...
          />
          {inCall && !hasCamera && (
            <div style={{ position: 'absolute', bottom: 16, right: 16, width: 160, height: 112, borderRadius: 12, background: '#1e293b', border: '2px solid rgba(255,255,255,0.25)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        {chatOpen && (
          <div style={{ width: 320, display: 'flex', flexDirection: 'column', background: '#0f1a2e', borderLeft: '1px solid rgba(255,255,255,0.08)' }}>
